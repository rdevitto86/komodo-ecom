...
// Package e2e_test contains end-to-end tests for komodo-shop-inventory-api.
...
// Override target URL:
//
//	BASE_URL=http://localhost:7044 go test -tags=e2e -v ./e2e/
package e2e_test
